...
<div class="dashboard-card">
<div class="card-header">
<h5 class="m-0"><i class="fas fa-receipt me-2"></i>Tax Payment History</h5>
</div>
<div class="card-body p-0">
<div class="table-responsive">
...
<?php
try {
$histSql = "SELECT id, declared_owner, arp_no, assessed_value, control_number, status, paid_at, created_at FROM tax_requests WHERE status IN('PAID','DECLINED','INSTALLMENT') ORDER BY COALESCE(paid_at, created_at) DESC";
